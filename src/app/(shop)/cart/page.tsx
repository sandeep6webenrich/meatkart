              ...
              <div className="col-md-6">
                <div className="transport">
                  ...
                  <div style={{ marginTop: 20 }}>
                     {items.length > 0 ? (
                       <Link href="/checkout" className="btn btn-primary btn-block" style={{ backgroundColor: '#019444', borderColor: '#019444', color: '#fff' }}>Proceed to Checkout</Link>
                     ) : (
                       <button className="btn btn-primary btn-block" disabled style={{ backgroundColor: '#ccc', borderColor: '#ccc', color: '#fff' }}>Proceed to Checkout</button>
                     )}
                  </div>
                </div>
              </div>
