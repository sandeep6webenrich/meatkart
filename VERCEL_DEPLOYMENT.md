...
- **Value:** `postgresql://postgres:[PASSWORD]@db.[PROJECT_ID].supabase.co:6543/postgres?pgbouncer=true`
...
- If runtime still cannot reach the DB, confirm `DATABASE_URL` uses port `6543` and includes `?pgbouncer=true`.
